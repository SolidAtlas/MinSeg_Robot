...
% We also got more pratice with using for loops and displaying information
% on plots and in the command window.
...
% new.
% The end result of this lab is that we learned a fast way to simulate a
% mass-spring-damper system with the ability to change the inputs and
% constants of the system and display our findings.
...
%      clear amp_x
     subplot(2,2,1)
     plot(freq,Amp_ratio);
     title('Max Amplitude F(frequency) C = 100')
...
display(resonant_frequency3)
 ...
 %%
open_system('Simulink_Lab2')
%%
open_system('Simulink_Lab2_2')
