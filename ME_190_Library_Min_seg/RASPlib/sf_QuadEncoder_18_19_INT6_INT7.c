/*
 * File: sf_QuadEncoder_18_19_INT6_INT7.c
 *
 *
  *
...
#define S_FUNCTION_NAME sf_QuadEncoder_18_19_INT6_INT7
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void sf_QuadEncoder_18_19_INT6_INT7_Outputs_wrapper(int16_T *pos1,
                          int16_T *pos2 ,
			      const real_T  *xD,
                          const uint8_T  *enc, const int_T  p_width0, 
                          const uint8_T  *pinA, const int_T  p_width1, 
                          const uint8_T  *pinB, const int_T p_width2);
extern void sf_QuadEncoder_18_19_INT6_INT7_Update_wrapper(const int16_T *pos1,
                          const int16_T *pos2 ,
                          real_T *xD, 
                          const uint8_T  *enc,  const int_T  p_width0,
                          const uint8_T  *pinA,  const int_T  p_width1,
...
{
    int16_T        *pos1  = (int16_T *)ssGetOutputPortRealSignal(S,0);
    int16_T        *pos2  = (int16_T *)ssGetOutputPortRealSignal(S,1);
    ...
    sf_QuadEncoder_18_19_INT6_INT7_Outputs_wrapper(pos1, pos2, xD, enc, p_width0, pinA, p_width1, pinB, p_width2);
}
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    sf_QuadEncoder_18_19_INT6_INT7_Update_wrapper(pos1, pos2,  xD, enc, p_width0, pinA, p_width1, pinB, p_width2);
}
