 ...
 *
 */
void sf_QuadEncoder_2_3_18_19_Outputs_wrapper(int16_T *pos1,
                          int16_T *pos2 ,
			      const real_T  *xD,
...
/*
  ...
  *
  */
void sf_QuadEncoder_2_3_18_19_Update_wrapper(const int16_T *pos1,
                          const int16_T *pos2 ,
                          real_T *xD, 
                          const uint8_T  *enc,  const int_T  p_width0,
                          const uint8_T  *pinA,  const int_T  p_width1,
...
if (xD[0]!=1) {
    ...
    # ifndef MATLAB_MEX_FILE
        ...
        pinMode(Enc[enc[1]].pinA, INPUT); // 6
        pinMode(Enc[enc[1]].pinB, INPUT); // 10		
