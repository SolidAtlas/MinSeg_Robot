...
# Autogenerated on: 19-Oct-2016 12:14:10
# Model: UNTITLED1
# MyTemplate
# File name: untitled1.mk
# Template: gmake 
...
COMPILER_CODEGEN_ARGS := -I"C:/MATLAB/SupportPackages/R2015a/arduinobase/toolbox/realtime/targets/arduino/include" -I"C:/MATLAB/SupportPackages/R2015a/arduinobase/toolbox/realtime/targets/arduino/blocks/sfcn/include" -I"C:/ME-190/RASPlib/untitled1_rtt" -I"C:/ME-190/RASPlib" -I"C:/Program Files/MatLAB/R2015a/extern/include" -I"C:/Program Files/MatLAB/R2015a/simulink/include" -I"C:/Program Files/MatLAB/R2015a/rtw/c/src" -I"C:/Program Files/MatLAB/R2015a/rtw/c/src/ext_mode/common" -I"C:/Program Files/MatLAB/R2015a/rtw/c/ert" -I"C:/MATLAB/SupportPackages/R2015a/arduino-1.0.5/hardware/arduino/cores/arduino" -I"C:/MATLAB/SupportPackages/R2015a/arduino-1.0.5/hardware/arduino/variants/mega" -I"C:/MATLAB/SupportPackages/R2015a/arduino-1.0.5/libraries/Servo" -mmcu=atmega2560 -ffunction-sections -fdata-sections -std=gnu99 -Wall -Wstrict-prototypes -g -Os -D"_RTT_USE_SERIAL0_=" -D"MODEL=untitled1" -D"NUMST=1" -D"NCSTATES=0" -D"HAVESTDIO=" -D"ONESTEPFCN=0" -D"TERMFCN=1" -D"MAT_FILE=0" -D"MULTI_INSTANCE_CODE=0" -D"INTEGER_CODE=0" -D"MT=0" -D"CLASSIC_INTERFACE=0" -D"ALLOCATIONFCN=0" -D"TID01EQ=0" -D"F_CPU=16000000" -D"ARDUINO=105" -D"_RUNONTARGETHARDWARE_BUILD_=" -D"_ROTH_MEGA2560_=" -D"_RTT_NUMSERVOS_=0"
...
POSTBUILD_ARGS := -O ihex -R .eeprom $(TARGET)  untitled1.hex
