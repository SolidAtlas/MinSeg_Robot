 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Tue Nov  5 19:46:01 2013
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sfcn_A11_out
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void sfcn_A11_out_Outputs_wrapper(const boolean_T *in,
                           
			      const real_T  *xD,
                          const uint8_T  *pin, const int_T p_width0);
extern void sfcn_A11_out_Update_wrapper(const boolean_T *in,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    sfcn_A11_out_Outputs_wrapper(in, xD, pin, p_width0);
}
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    sfcn_A11_out_Update_wrapper(in,  xD, pin, p_width0);
}
