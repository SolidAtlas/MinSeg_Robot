...
#define S_FUNCTION_NAME sfcn_PWM45
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void sfcn_PWM45_Outputs_wrapper(const uint8_T *in,
                           
			      const real_T  *xD,
                          const uint8_T  *pin, const int_T p_width0);
extern void sfcn_PWM45_Update_wrapper(const uint8_T *in,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    sfcn_PWM45_Outputs_wrapper(in, xD, pin, p_width0);
}
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    sfcn_PWM45_Update_wrapper(in,  xD, pin, p_width0);
}
