 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Tue Jun 11 17:03:37 2013
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sf_HMC5883L
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void sf_HMC5883L_Outputs_wrapper(int16_T *x_val,
                          int16_T *y_val,
                          int16_T *z_val,
                          const real_T  *xD);
extern void sf_HMC5883L_Update_wrapper(const int16_T *x_val,
                          const int16_T *y_val,
                          const int16_T *z_val,
                          real_T *xD);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    sf_HMC5883L_Outputs_wrapper(x_val, y_val, z_val, xD);
}
