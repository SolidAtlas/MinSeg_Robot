...
// Encoder using PCINT vector will be ENC[1]
 ...
 *
 */
void sf_QuadEncoder_18_19_15_62_Outputs_wrapper(int16_T *pos1,
                          int16_T *pos2 ,
			      const real_T  *xD,
...
/*
  ...
  *
  */
void sf_QuadEncoder_18_19_15_62_Update_wrapper(const int16_T *pos1,
                          const int16_T *pos2 ,
                          real_T *xD, 
                          const uint8_T  *enc,  const int_T  p_width0,
                          const uint8_T  *pinA,  const int_T  p_width1,
